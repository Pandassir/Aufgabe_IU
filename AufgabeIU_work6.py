...
#df_itest.to_sql('datensatz_test', engine)
#df_train.to_sql('datensatz_test_vs_y2_ideal', engine)
#df_train.to_sql('datensatz_test_vs_y11_ideal', engine)
#df_train.to_sql('datensatz_test_vs_y33_ideal', engine)
#df_train.to_sql('datensatz_test_vs_y36_ideal', engine)
...
#print(df)
'''Zur Visualisierung wurde die Dataframes in MySQL visualisiert über select *
tablename und die Grafik wurde gespeichert. Diese Grafik wird hier visualisert:'''
